...
function recebeEvento(evento){
    ...
    if (resultado < 18.5) {
        ...
        resposta.innerHTML= `tu tá com obesidade severa velho, para de comer mano:(`;
        ...
        resposta.innerHTML = `tu tem que colocar alguma coisa seu gay, acha que tu aqui pra zoar??`;
